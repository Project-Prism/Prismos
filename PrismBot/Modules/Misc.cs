...
namespace PrismBot.Modules
{
    public class Misc : InteractionModuleBase<SocketInteractionContext<SocketSlashCommand>>
    {
        ...
        public async Task Help()
        {
            ...
            miscembed.AddField("p?kitty", "Returns a random image of a cat.");
            ...
            funembed.AddField("p?meme", "Returns a random meme.");
            ...
            nsfwembed.AddField("p?nsfw", "Returns a random NSFW image. This command can only be used in an NSFW channel.");
            nsfwembed.AddField("p?hentai", "Returns a random hentai image. This command can only be used in an NSFW channel.");
